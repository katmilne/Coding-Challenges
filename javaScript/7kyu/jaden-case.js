...
check out how contractions are expected to be in the 
example below.
...
String.prototype.toJadenCase = function () { 
    return this.split(" ").map(function(word){
      return word.charAt(0).toUpperCase() + word.slice(1); //slice(1) cuts off first letter e.g. the previosuly lowercase letter
    }).join(" ");
  }
